...
int main()
{
    ...
    // If the node with the maximum height is a leaf
    ...
    {
        // Find the child containing the maximum leaf
        ...
        // Remove the searched set from the root's leaf set
    ...
    // Update the second maximum leaf's `e` value to the maximum height
