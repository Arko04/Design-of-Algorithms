// https://chatgpt.com/share/676ad379-e41c-8003-a29e-42ded5d07768

/* one of the important prompt: can you add a part at the end of my code(before return 0)
that calculate the minimum distance from 1 to 2 and 2 to 3 and 1 to 3? using bfs */
/* one of the important prompt:can you do the same thing with the country2 and county3 
like what i do with country1 */
#include <iostream>
#include <vector>
#include <string>
#include <queue>
